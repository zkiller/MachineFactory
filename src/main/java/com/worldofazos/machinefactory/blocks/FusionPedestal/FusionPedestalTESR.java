...
public class FusionPedestalTESR extends TileEntitySpecialRenderer<FusionPedestalTE>{

    @Override
    public void renderTileEntityAt(FusionPedestalTE te, double x, double y, double z, float partialTicks, int destroyStage) {
        ...
        if (stack != null) {
            ...
            GlStateManager.translate(x + 0.5, y + 0.90 + offset, z + 0.5);
