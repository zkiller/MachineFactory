...
public class VoidOreMinerGui extends GuiContainer {

    private static final ResourceLocation BG_TEXTURE = new ResourceLocation(Infos.MODID, "textures/gui/machine/void_ore_miner.png");
    public static final int WIDTH = 176;
    public static final int HEIGHT = 166;

    private VoidOreMinerTE te;

    public VoidOreMinerGui(VoidOreMinerTE tileEntity, VoidOreMinerContainer container) {
        super(container);
        xSize = WIDTH;
        ySize = HEIGHT;
        te = tileEntity;
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if(this.te.cookTime > 0){
            ...
            this.drawTexturedModalRect(guiLeft + 77, guiTop + 51, 177, 46, e, 15);
        }

        String Name = I18n.translateToLocal("Void Ore Miner");
