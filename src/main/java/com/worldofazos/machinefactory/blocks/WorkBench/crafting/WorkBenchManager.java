...
public class WorkBenchManager {
    ...
    public WorkBenchManager(){
        ...
        // Add Vanilla recipes
        //List recipes_vanilla = CraftingManager.getInstance().getRecipeList();

        //this.getRecipeList().addAll(recipes_vanilla);
    }

    /**
     * Returns the static instance of this class
     */
    public static final WorkBenchManager getInstance() {
        /** The static instance of this class */
        return instance;
    }

    public WorkbenchShapedRecipe addRecipe(ItemStack result, Object... recipe) {
        String s = "";
        int i = 0;
        int width = 0;
        int height = 0;
        ...
        WorkbenchShapedRecipe shapedrecipes = new WorkbenchShapedRecipe(width, height, ingredients, result);
        this.recipes.add(shapedrecipes);
        return shapedrecipes;
    }

    public WorkbenchShapedOreRecipe addShapedOreRecipe(ItemStack result, Object... recipe) {
        WorkbenchShapedOreRecipe craft = new WorkbenchShapedOreRecipe(result, recipe);
        recipes.add(craft);
        return craft;
    }

    public WorkbenchShapelessRecipe addShapelessRecipe(ItemStack result, Object... ingredients) {
        ...
        WorkbenchShapelessRecipe recipe = new WorkbenchShapelessRecipe(result, arraylist);
