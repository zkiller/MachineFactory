...
public class SmelterGUI extends GuiContainer {
    ...
    private static final ResourceLocation BG_TEXTURE = new ResourceLocation(Infos.MODID, "textures/gui/machine/smelter.png");
    public static final int WIDTH = 176;
    public static final int HEIGHT = 166;

    private SmelterTE te;

    public SmelterGUI(SmelterTE tileEntity, SmelterContainer container) {
        super(container);
        xSize = WIDTH;
        ySize = HEIGHT;
        te = tileEntity;
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      //  }
        ...
        String Name = I18n.translateToLocal("Smelter");
