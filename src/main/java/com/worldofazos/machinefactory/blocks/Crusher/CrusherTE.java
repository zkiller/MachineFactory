...
public class CrusherTE extends TileEntityMachineBase{

    public ItemStackHandler inputSlot = new ItemStackHandler(1);
    public ItemStackHandler outputSlot = new ItemStackHandler(2);
    ...
    public boolean canSmelt(){
        if(StackUtil.isValid(this.inputSlot.getStackInSlot(0))){
            ItemStack output = CrusherRecipes.instance().getResult(this.inputSlot.getStackInSlot(0));
