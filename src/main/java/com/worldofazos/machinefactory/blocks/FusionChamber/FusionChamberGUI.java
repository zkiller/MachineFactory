...
public class FusionChamberGUI extends GuiContainer {

    private static final ResourceLocation BG_TEXTURE = new ResourceLocation(Infos.MODID, "textures/gui/machine/fusion_chamber.png");
    public static final int WIDTH = 176;
    public static final int HEIGHT = 166;

    private FusionChamberTE te;

    public FusionChamberGUI(FusionChamberTE tileEntity, FusionChamberContainer container) {
        super(container);
        xSize = WIDTH;
        ySize = HEIGHT;
        te = tileEntity;
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
       ...
       // if(this.te.cookTime > 0){
        ...
        this.drawTexturedModalRect(guiLeft + 87, guiTop + 32, 177, 46, e, 15);
      //  }

        String Name = I18n.translateToLocal("Fusion Chamber");
