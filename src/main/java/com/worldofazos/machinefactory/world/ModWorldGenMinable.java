...
public class ModWorldGenMinable extends WorldGenerator {
    ...
    public ModWorldGenMinable(IBlockState state, int blockCount, int dimension)
    {
        this(state, blockCount, BlockMatcher.forBlock(determineDimension(dimension)));
    }

    // Dimension ID determines blocks to replace
    ...
    public ModWorldGenMinable(IBlockState state, int blockCount, Predicate<IBlockState> predicate)
    {
        this.oreBlock = state;
